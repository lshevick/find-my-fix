...
const Dashboard = () => {
      ...
      <div className="fixed inset-0 flex items-center justify-center p-4">
        <Dialog.Panel className="mx-auto max-w-sm rounded bg-white p-10">
          ...
          <div className="m-3">
            ...
            <ul>
            {car.service_list && car.service_list.map(i => <li key={i} className='capitalize font-light text-sm list-disc'>{i}</li>)}
            </ul>
          </div>
  ...
  return (
    <>
      ...
      <div className={`flex flex-col bg-stone-300 items-center justify-center w-full min-h-screen ${isOpen && `blur`}`}>
